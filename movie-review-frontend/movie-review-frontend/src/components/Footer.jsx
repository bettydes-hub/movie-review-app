      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">MovieReview</h3>
            <p className="text-gray-300 mb-4">
              Discover, review, and share your thoughts on the latest movies. 
              Join our community of movie enthusiasts and critics.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2024 MovieReview. All rights reserved.
          </p>
          <p className="text-gray-300 text-sm flex items-center mt-2 md:mt-0">
            Made with <FaHeart className="text-red-500 mx-1" /> by MovieReview Team
          </p>
        </div>
      </div>
    </footer>
